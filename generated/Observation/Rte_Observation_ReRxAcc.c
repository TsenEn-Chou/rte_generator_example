...
Std_ReturnType Rte_Read_RpIfVehAcc_Acc(Impl_uint8* data, Std_TransformerError transformerError){

     Std_ReturnType      return_value0 = RTE_Fetch(data, &R2_Acc, sizeof(MyUint8OfVendorID));
